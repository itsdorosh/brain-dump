  ...
  return (
    <form className='dumper' onSubmit={handleSubmit}>
      ...
      <div className='deadline'>
        <div className='check'>
          <input type='checkbox' id='hasDeadline' checked={hasDeadline} onChange={() => setHasDeadline(!hasDeadline)} />
          <label htmlFor='hasDeadline'>is this shit has deadline? 🔥</label>
        </div>

        {hasDeadline && <input type='date' value={deadline} onChange={({ target: { value } }) => setDeadline(value)} />}
      </div>
